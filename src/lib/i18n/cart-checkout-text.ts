...
export const cartText = {
  no: {
    ...
    redirectingToCheckout: 'Går til kassen...',
  ...
  en: {
    ...
    redirectingToCheckout: 'Going to checkout...',
...
export const checkoutText = {
  no: {
    ...
    sessionExpired: 'Økten har utløpt. Vennligst last siden på nytt og prøv igjen.',
    ...
    invalidPostalCode: 'Postnummer må være 4 siffer',
    continueShopping: 'Fortsett å handle',
  },
  en: {
    title: 'Checkout',
    ...
    invalidPostalCode: 'Postal code must be 4 digits',
    continueShopping: 'Continue shopping',
  },
} as const;
