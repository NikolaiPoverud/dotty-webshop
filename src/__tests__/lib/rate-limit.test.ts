...
describe('Rate Limiting', () => {
  ...
  describe('checkRateLimit', () => {
    it('should allow first request', async () => {
      const result = await checkRateLimit('test-ip-1', { maxRequests: 5, windowMs: 60000 })
    ...
    it('should reset after window expires', async () => {
      ...
      const identifier = 'test-ip-4-' + Date.now()
  ...
  describe('getClientIp', () => {
    it('should prefer x-real-ip header (Vercel trusted)', () => {
