...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  'Content-Security-Policy': [
    ...
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://www.google-analytics.com https://vitals.vercel-insights.com https://*.ingest.sentry.io https://*.sentry.io",
